...
public:
	...
	std::wstring getApiConfig(const std::wstring& provider, const std::wstring& key);
	void setApiConfig(const std::wstring& provider, const std::wstring& key, const std::wstring& value);
private:
	Setting();
